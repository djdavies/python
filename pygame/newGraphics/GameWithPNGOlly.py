...
#						printText("hi",screen)
				...
				if event.key == pygame.K_c:
				  # if key pressed is 'C' key, move CABBAGE (check if moving from left to right or other way)
					...
					if cabbageMove == STOP and cabbagePosition.left > 483 and farmerPosition.left >101:
						cabbageMove = LEFT
						farmerMove=LEFT
					elif cabbageMove == STOP and cabbagePosition.left < 483 and farmerPosition.left <101:
						cabbageMove = RIGHT 
						farmerMove=RIGHT
							
				if event.key == pygame.K_w:
				  # if key pressed is 'W' key, move WOLF (check if moving from left to right or other way)
					if wolfMove == STOP and wolfPosition.left > 483 and farmerPosition.left >101:
						wolfMove = LEFT
						farmerMove=LEFT
					#elif wolfMove == STOP and wolfPosition.left < 483 and farmerPosition.left <483:
					elif wolfMove == STOP and wolfPosition.left < 483 and farmerPosition.left <101:
						wolfMove = RIGHT
						farmerMove=RIGHT
				...
				#	if sheepMove == STOP and sheepPosition.left > 101 and farmerPosition.left >483:
					if sheepMove == STOP and sheepPosition.left > 483 and farmerPosition.left >101:
						sheepMove = LEFT
						farmerMove=LEFT
					#elif sheepMove == STOP and sheepPosition.left < 483 and farmerPosition.left <483:
					elif sheepMove == STOP and sheepPosition.left < 483 and farmerPosition.left <101:
						sheepMove = RIGHT
						farmerMove=RIGHT
