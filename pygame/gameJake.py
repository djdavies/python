...
import os
import pygame
from pygame.locals import * #- not needed, run fine without
#import time # trying to pause before restart/lose game - not needed, time is imported via * 
...
#------------Main Function: drawing, plotting, images-------------------------------------------------------------------------
def main():
